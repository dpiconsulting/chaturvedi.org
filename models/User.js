...
User.add({
	...
	occupation: { type: Types.Textarea },
	education: { type: Types.Textarea },
	lived: { type: Types.Textarea },
	visited: { type: Types.Textarea },
	languages: { type: Types.Select, options: ['English', 'Hindi', 'Spanish'] },
	relationship: { type: Types.Select, options: ['Single', 'Married', 'Complicated'] },
	photo: { type: Types.CloudinaryImage, collapse: true },
